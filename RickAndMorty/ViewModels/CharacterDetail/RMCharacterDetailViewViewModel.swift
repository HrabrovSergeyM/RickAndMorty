...
final class RMCharacterDetailViewViewModel {
    ...
    enum SectionType {
        ...
        case information(vm: [RMCharacterInfoCollectionViewCellViewModel])
        case episodes(vm: [RMCharacterEpisodeCollectionViewCellViewModel])
    }
    ...
    private func setupSections() {
        sections = [
            ...
            .episodes(vm: character.episode.compactMap {
